                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td rowSpan="2">Jumlah Pemesanan :
                                ...
                                <button className="button_decrement" onClick={this.handleDecrement}><span className="icon"><i className="fa fa-minus" /></span></button>&emsp;
                                <button onClick={this.handleIncrement} className="button_increment"><span className="icon"><i className="fa fa-plus" /></span></button>
                                <br />
